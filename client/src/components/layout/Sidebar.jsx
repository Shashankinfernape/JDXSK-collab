// --- FIX: Correctly import useState and useEffect ---
...
// Original 4 theme icons + Instagram
...
// Header and SearchBar styling remains the same (with flex-shrink: 0)
...
const Sidebar = ({ onChatSelect }) => {
  ...
  // Search Debounce Effect - Keep this
  useEffect(() => {
    if (!searchQuery.trim()) {
      setSearchResults([]);
  ...
  const renderThemeIcon = () => {
    switch (themeName) {
      ...
      case 'instagram': return <FaInstagram />; // Add Instagram
